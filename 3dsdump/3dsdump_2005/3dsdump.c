/*
    ...
    2015 bg57iv3#github & JetMeta : show me more dump ...
...
History:
2015-05-29 （BG57IV3）
	1. add track & key info.
2015-10-20
    2. add pivot and matrix info.
*/
...
static void matrix_dump(float matrix[4][4])
{
    int i, j;
...
static void matrix_dump_level(float matrix[4][4],int level)
{
    int i, j;
    char l[128];
...
static void dump_instances_level(Lib3dsNode *node, const char* parent,int level)
{
    Lib3dsNode *p;
    char name[255];
    char l[128];
...
static void key_dump(Lib3dsKey *key,int level)
{
    char l[128];
...
static void track_dump(Lib3dsTrack *track, int level,const char* trackname)
{
    //cc Lib3dsNode *p;
    char l[128];
    int i = 0;
