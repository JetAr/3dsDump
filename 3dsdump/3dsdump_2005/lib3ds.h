...
typedef struct Lib3dsIo
{
    ...
    //cc Get current position in stream
...
//cc according to type, know no. of elems.
...
typedef struct Lib3dsMeshInstanceNode
{
    ...
    float           morph_smooth;
    char            morph[64];
    Lib3dsTrack     pos_track;//cc position
    Lib3dsTrack     rot_track;//cc rotation
    Lib3dsTrack     scl_track;//cc scale
    Lib3dsTrack     hide_track;//cc visible??
